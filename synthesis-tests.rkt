...
(module+ test
  ...
  (test= "3 ways to code hello"
         (length (run 3 (out) (fresh (code store) (parseo-nh out code) (evalo code (jstr "Hello") store))))
         3)
  ...
  (test= "if/var case"
         (length (run 1 (inside) (fresh (code store)
                                        (parseo-h `(call (function () (if #f (var x) (return x))))
                                                  code)
  ...
  ;                             (lookupo (jstr "public") obj (jobj `((,(jstr "1") . ,(jnum 1))(,(jstr "2") . ,(jnum 2)))))
  ;                             )))
  ;         1)
