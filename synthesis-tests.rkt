...
;           1)
         ...
         (run 1 (fragment)
           (PBE (lambda (n)
                ...
                `(((3) ,(jnum 3))
                  ((4) ,(jnum 6)))))
         '(((op + total i))))
  (test= "For loop range sum (slow, ~30 seconds)"
         (run 1 (fragment)
           (PBE (lambda (n)
                  `(call (function ()
                                   (var (total 0))
                ...
                `(((3) ,(jnum 3))
                  ((4) ,(jnum 6)))))
         '((total (op + total i))))
  (test= "For loop range sum (slow, ~25 seconds)"
         (run 1 (fragment)
           (PBE (lambda (n)
                  `(call (function ()
                                   (var (total 0))
  ...
  (test= "FULL For loop range sum (~600 milliseconds)"
         (run 1 (fragment)
           (PBE (lambda (n)
                  `(call (function (n)
                                   (var (total 0))
                ...
                `(((3) ,(jnum 3))
                  ((4) ,(jnum 6)))))
         '(((op + i total))))
  #;(test= "FULL For loop range sum (very slow, ~10 minutes)"
         (run 1 (fragment)
           (PBE (lambda (n)
                  `(call (function (n)
                                   (var (total 0))
                ...
                `(((3) ,(jnum 3))
                  ((4) ,(jnum 6)))))
         '((total (op + i total))))
  (test= "FULL For loop range sum (very slow, ~5 minutes)"
         (run 1 (fragment)
           (PBE (lambda (n)
                  `(call (function (n)
                                   (var (total 0))
